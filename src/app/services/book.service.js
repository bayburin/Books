...
export function BookService($cookies) {
   ...
   * Список книг
   */
  let bookList = JSON.parse(localStorage.getItem(STORAGE_NAME));
  /**
   ...
   */
  let saveBooksToLocalStorage = () => localStorage.setItem(STORAGE_NAME, JSON.stringify(bookList));
  ...
  /**
   * Вернуть изначальный список книг
   */
